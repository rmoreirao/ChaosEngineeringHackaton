...
def generate_image(
    ...
    """Generate image using the Images API with gpt-image-1.5."""
    kwargs = {
        "model": "gpt-image-1.5",
        "prompt": prompt,
        "n": 1,
...
def main():
    ...
    parser.add_argument(
        "--azure-endpoint",
        default="https://ai-foundry-ai-agents-for-beginners.openai.azure.com/",
        help="Azure OpenAI endpoint URL (default: https://ai-foundry-ai-agents-for-beginners.openai.azure.com/). "
             "Used with DefaultAzureCredential when no API key is provided."
    )

    args = parser.parse_args()

    # Determine client: API key (direct OpenAI) or Azure DefaultAzureCredential
    ...
    if api_key:
        ...
        endpoint = args.azure_endpoint.rstrip("/") + "/openai/v1/"
        ...
        print(f"Using Azure OpenAI at {args.azure_endpoint}")
    ...
    if args.input_image:
        ...
        # Generation mode - use Images API
