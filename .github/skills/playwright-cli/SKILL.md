...
Playwright CLI is headless by default. Pass `--headed` to `open` to see the browser:
...
Use `playwright-cli show` to open a visual dashboard that lets you see and control all running browser sessions. This is useful when agents are running browser automation in the background and you want to observe their progress or step in to help.
...
# Open in headed mode (browser visible)
playwright-cli open --headed
# Open in headed mode with a specific URL
